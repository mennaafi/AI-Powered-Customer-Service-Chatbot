...
class RecommendationAgent():
    ...
    def get_apriori_recommendation(self,products,top_k=5):
        ...
        for product in products:
            if product in self.apriori_recommendations:
                  recommendation_list = recommendation_list + self.apriori_recommendations[product]
    ...
    def get_response(self,messages):
        ...
        if recommendations == []:
            return {"role": "assistant", "parts":"Sorry, I can't help with that. Can I help you with your order?"}
